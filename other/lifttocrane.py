...
def main():
  ...
  liftGrab(movement="down", speed=100)
  lineFollowingDistance(distance=355, sensor=LeftColor, sideofsensor='out', speed=200, proportion=0.8)
  durn(turn=-15, type="tank", speed=200)
  time.sleep(1)
  straight(75, speed=200)
  liftGrab(movement="up", speed=100)
  straight(-75, speed=200)
  durn(turn=-280, type="tank")

  # ** Return to Intersection C **
  ...
  lineFollowingDistance(distance=200, sensor=LeftColor, sideofsensor='out', speed=300, proportion=1.2)
  ...
  durn(turn=-180, type="tank")
  sweep(sensor=LeftColor, direction="left", whiteFirst=True)
  lineFollowingDistance(distance=320, sensor=LeftColor, sideofsensor='out', speed=300, proportion=0.8)

  # ** Drop Off Containers **
  liftGrab(movement="down", speed=100, percentage=0.5)
  durn(turn=-5, type="tank", speed=200)
  straight(40, speed=200)
  liftGrab(movement="down", speed=100, percentage=0.5)
  straight(-40, speed=200)
  durn(turn=5, type="tank", speed=200)
